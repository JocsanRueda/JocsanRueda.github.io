      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 opacity-90">
          ...
          <div className="lg:col-span-2">
              ...
              <CardHeader className="flex flex-row items-center">
                ...
                <div className="flex flex-col">
                  <CardTitle className="flex flex-col">
                    ...
                    <span className="p-1 rounded shadow -mt-2.5 z-0 bg-blue-900"></span>
                  </CardTitle>
                </div>
              </CardHeader>
              <CardContent>
            ...
            {/* Responsabilidades */}
            <Card className="bg-black text-white border-gray-900 shadow-lg dark:shadow-none mb-8">
              <CardHeader className="flex flex-row items-center">
                <CheckCheck size={28} />
                <div className="flex flex-col">
                  <CardTitle className="flex flex-col">
                    <p className="z-10 text-lg">Responsabilidades</p>
                    <span className="p-1 rounded shadow -mt-2.5 z-0 bg-red-900"></span>
                  </CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                ...
                <CardHeader className="flex flex-row items-center">
                  ...
                  <div className="flex flex-col">
                    <CardTitle className="flex flex-col">
                      ...
                      <span className="p-1 rounded shadow -mt-2.5 z-0 bg-green-900"></span>
                    </CardTitle>
                  </div>
                </CardHeader>
                <CardContent>
            ...
            <Card className="bg-black text-white border-gray-900 mb-8 shadow-lg dark:shadow-none">
              <CardHeader className="flex flex-row items-center">
                ...
                <div className="flex flex-col">
                  <CardTitle className="flex flex-col">
                    ...
                    <span className="p-1 rounded shadow -mt-2.5 z-0 bg-orange-900"></span>
                  </CardTitle>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300">{experience.contractType}</p>
                </div>
