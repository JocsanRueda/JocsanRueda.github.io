...
export default function CardExperience({
  ...
  return (
    <div className={cn("bg-sidebar dark:bg-black  dark:text-white  p-6   flex flex-col gap-7 justify-between border rounded-md  dark:border-gray-900   max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl   transition-opacity hover:opacity-100 ",className)} id={id} >
      <CardHeader className="flex flex-row items-center gap-3 cursor-pointer " onClick={handleClick}>
